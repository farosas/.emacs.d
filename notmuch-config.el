 ...
 '(notmuch-saved-searches
   (quote
    ((:name "inbox" :query "to:farosas tag:unread")
     (:name "qemu-devel" :query "to:qemu-devel")
     (:name "qemu-ppc" :query "to:qemu-ppc")
     (:name "kvm-ppc" :query "to:kvm-ppc")
     (:name "linuxppc-dev" :query "to:linuxppc-dev")
     (:name "libvirt" :query "to:libvirt")
     (:name "power-port-tune" :query "to:power-port-tune")
